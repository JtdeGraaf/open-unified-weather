...
import com.openunifiedweather.common.extensions.toDate
import com.openunifiedweather.domain.model.location.model.Location
import com.openunifiedweather.domain.model.weather.model.AirQuality
import com.openunifiedweather.domain.model.weather.model.HalfDay
...
import com.openunifiedweather.domain.model.weather.model.Precipitation
import com.openunifiedweather.domain.model.weather.model.PrecipitationProbability
import com.openunifiedweather.domain.model.weather.model.Temperature
import com.openunifiedweather.domain.model.weather.model.UV
import com.openunifiedweather.domain.model.weather.model.WeatherCode
import com.openunifiedweather.domain.model.weather.model.Wind
...
import com.openunifiedweather.domain.sources.openmeteo.json.OpenMeteoAirQualityHourly
import com.openunifiedweather.domain.sources.openmeteo.json.OpenMeteoAirQualityResult
import com.openunifiedweather.domain.sources.openmeteo.json.OpenMeteoLocationResult
import com.openunifiedweather.domain.sources.openmeteo.json.OpenMeteoWeatherCurrent
import com.openunifiedweather.domain.sources.openmeteo.json.OpenMeteoWeatherDaily
import com.openunifiedweather.domain.sources.openmeteo.json.OpenMeteoWeatherHourly
import com.openunifiedweather.domain.sources.openmeteo.json.OpenMeteoWeatherMinutely
    ...
    for (i in hourlyResult.time.indices) {
        hourlyList.add(
            HourlyWrapper(
                ...
                weatherText = getWeatherText(hourlyResult.weatherCode?.getOrNull(i)),
